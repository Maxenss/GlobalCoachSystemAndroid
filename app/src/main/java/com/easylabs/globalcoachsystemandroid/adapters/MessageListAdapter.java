...
public class MessageListAdapter extends RecyclerView.Adapter {
    ...
    public MessageListAdapter(Context context, ArrayList<Message> messageList) {
        ...
        System.out.println("MessageListAdapter constr - " + mMessageList.size());
    }

    @Override
    public int getItemCount() {
        System.out.println("getItemCount");
        System.out.println("mMessageList.size() - " + mMessageList.size());
    ...
    public int getItemViewType(int position) {
        ...
        if (message.getSender().getId() == SessionData.currentUser.getId()) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_TYPE_MESSAGE_SENT) {
            view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.item_message_sent, parent, true);
    ...
    private class SentMessageHolder extends RecyclerView.ViewHolder {
        ...
        SentMessageHolder(View itemView) {
            ...
            System.out.println("В SentMessageHolder");
    ...
    public class ReceivedMessageHolder extends RecyclerView.ViewHolder {
        ...
        void bind(Message message) {
          ...
          //  nameText.setText(message.getSender().getAlias());
